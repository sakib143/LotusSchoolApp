...
class StandardAdapter  (val context: Context, var dataSource: List<StandardListModel.Data>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.tvKnowledgeType.text = dataSource.get(position).groupname
        return view
    }
